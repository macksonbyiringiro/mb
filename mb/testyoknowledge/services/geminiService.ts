...
export const evaluateAnswers = async (userInfo: UserInfo, answers: InterviewAnswer[], introduction: string): Promise<EvaluationResult> => {
    const languageName = userInfo.language === 'en-US' ? 'English' : 'Kinyarwanda';
    ...
    const prompt = `
      ...
      **User's Self-Introduction:**
      ${introduction || "The user did not provide a self-introduction."}
